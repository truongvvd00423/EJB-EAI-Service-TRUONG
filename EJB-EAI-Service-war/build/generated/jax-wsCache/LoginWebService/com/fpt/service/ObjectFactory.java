 ...
 * generated in the com.fpt.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _CheckLogin_QNAME = new QName("http://service.fpt.com/", "checkLogin");
    private final static QName _CheckLoginResponse_QNAME = new QName("http://service.fpt.com/", "checkLoginResponse");
    private final static QName _Hello_QNAME = new QName("http://service.fpt.com/", "hello");
    private final static QName _HelloResponse_QNAME = new QName("http://service.fpt.com/", "helloResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.fpt.service
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://service.fpt.com/", name = "checkLogin")
     ...
     */
    @XmlElementDecl(namespace = "http://service.fpt.com/", name = "checkLoginResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://service.fpt.com/", name = "hello")
     ...
     */
    @XmlElementDecl(namespace = "http://service.fpt.com/", name = "helloResponse")
